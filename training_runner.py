...
if args.doIndices:
    make_split_file(args.indicesInput, train_val_test_split=[0.05,0.05], output_path=args.indicesOutputPath, nfolds=args.numFolds, seed=0, fully_contained=True, testOnly=False, classification=False, stopMu=False)
